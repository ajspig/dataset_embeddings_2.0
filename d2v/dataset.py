...
class Dataset(object):
    ...
    def __init__(self,configuration,rootdir,use_valid=False):
        ...
        # splits_file = "/users/guest/j/jhiggin6/Documents/Thesis/d2v/metadataset/searchspace-a/searchspace-a-splits.csv"
        ...
        for split in iterates:
            ...
            # train-0
            # files = [
            #          'molec-biol-splice', 'twonorm', 'plant-texture', 'ringnorm', 'spect', 'energy-y2', 'steel-plates',
            #          'vertebral-column-3clases', 'chess-krvk', 'statlog-shuttle', 'breast-cancer-wisc', 'semeion',
            #          'connect-4', 'monks-3', 'wall-following', 'vertebral-column-2clases', 'planning', 
            #          'cardiotocography-3clases', 'plant-margin', 'nursery', 'titanic', 'energy-y1', 'monks-1',
            #          'arrhythmia', 'breast-tissue', 'statlog-australian-credit', 'tic-tac-toe', 'lymphography',
            #          'monks-2', 'waveform', 'fertility', 'lenses', 'wine-quality-red', 'parkinsons', 'wine-quality-white'
            #          'pima', 'pittsburg-bridges-T-OR-D', 'low-res-spect', 'musk-1', 'pittsburg-bridges-REL-L',
            #          'breast-cancer', 'spambase', 'iris', 'thyroid', 'mammographic', 'ilpd-indian-liver', 'blood',
            #          'waveform-noise', 'statlog-heart', 'pittsburg-bridges-TYPE', 'echocardiogram', 'flags', 'letter',
            #          'zoo', 'ecoli', 'yeast', 'hayes-roth', 'libras', 'breast-cancer-wisc-prog', 'glass', 'adult',
            #          'annealing', 'molec-biol-promoter', 'contrac', 'statlog-landsat', 'conn-bench-sonar-mines-rocks',
            #          'musk-2', 'balloons', 'abalone', 'statlog-vehicle', 'page-blocks', 'heart-hungarian', 'ionosphere',
            #          'synthetic-control', 'plant-shape', 'pittsburg-bridges-MATERIAL', 'breast-cancer-wisc-diag', 'spectf',
            #          'bank', 'pendigits'
            #           ]   
            
            for file in files:  # for c, file in enumerate(files):
