...
def main(unused_argv):
  ...
  train_iter = tf.compat.v1.data.make_initializable_iterator(train_batch)
  val_iter = tf.compat.v1.data.make_initializable_iterator(val_batch)
  test_iter = tf.compat.v1.data.make_initializable_iterator(test_batch)
  ...
  softmax_orig_key_op = tf.compat.v1.reduce_mean(
